...
const AnnouncementGrid = memo(({ filtered, categoriesById, onAnnouncementClick }) => (
  <ul className="grid gap-6 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 px-0 p-2">
    {filtered.map(item => (
      <AnnouncementCard
        key={item.id}
        announcement={item}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <footer className="flex items-center justify-between pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">º
          <span
