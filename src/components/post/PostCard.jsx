  ...
  return (
    <div className="space-y-2 rounded-lg outline outline-slate-300 p-4 shadow-sm dark:outline-slate-600 dark:bg-slate-800 relative mb-8">
      <div className="flex justify-between">
         {!isCardAdmin &&  <button onClick={() => askEditPost(post)} disabled={isCardAdmin} className="absolute right-1 top-1 rounded-tr-lg rounded  bg-blue-600 px-1.5 py-0.5 text-xs font-semibold text-white hover:bg-blue-700">
